...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('dist/css/jsgrid.min.css') }}">
  <link rel="stylesheet" href="{{ asset('dist/css/jsgrid-theme.min.css') }}">
  <!-- Select2 -->
  ...
  <!-- summernote -->
  <link href="{{ asset('dist/summernotes/summernote-bs4.min.css') }}" rel="stylesheet">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{ route('admin.units') }}" class="nav-link @if(Route::currentRouteName() === 'admin.units') active @endif">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Units</p>
                </a>
              </li>
...
<script src="{{ asset('dist/js/jsgrid.min.js') }}"></script>
...
<!-- Summernote -->
<script src="{{ asset('dist/summernotes/summernote-bs4.min.js') }}"></script>

{{-- // Global Script --}}
<script>
    $(".validation-error-messages").fadeTo(5000, 500).slideUp(500, function(){
        $(".validation-error-messages").slideUp(500);
    });
    $(".success-messages").fadeTo(5000, 500).slideUp(500, function(){
